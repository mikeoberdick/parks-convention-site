					...
					<div id = "mainInfo" class = "row mb-3">
						<div class="col-lg-8">
							...
							<div id="videoViewer" class = "d-none embed-responsive embed-responsive-16by9">
								<iframe class = "embed-responsive-item lazy" width="560" height="315" src="https://www.youtube.com/embed/<?php echo $videoID; ?>?version=3&loop=1&playlist=<?php echo $videoID; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							</div><!-- #videoViewer -->
						<?php endif; ?>
						</div><!-- .col-lg-8 -->
						<div class="col-lg-4 mt-3 mt-lg-0">
							...
							<h4 class="price mb-3 text-center">
								Call For Special Convention Pricing
							</h4>
							<div class="contact-buttons mb-3">
								...
								<a data-toggle = "modal" data-target = "#virtualMeeting"><button role = 'button' class = 'btn gold-outline-button'><i class="fa fa-comments mr-2" aria-hidden="true"></i>Chat With Us</button></a>
							</div><!-- .contact-buttons -->
							<div class="spec">
...
<div class = "col-6 col-md-2 thumb gallery-thumb mb-3 <?php if ( $i === 0 ) {echo 'selected';} ?><?php if ( $i >= 11 && !empty($videoURL) ) {echo 'hidden';} elseif ( $i >= 12 && empty($videoURL) ) {echo 'hidden';} ?>">
				...
				<h3 class="fancy mb-5">Description</h3>
					...
					<div id = "description" class="row">
						<div class="col-sm-12">
							<div class="content-wrapper p-5 text-center">
								...
								<p class = "text-white"><?php the_field('description'); ?></p>
								<p class = "mb-0 callout text-white"><?php the_field('description_box_footer','option'); ?></p>
							</div><!-- .content-wrapper -->
						</div><!-- .col-sm-12 -->
					</div><!-- #description -->
				</div><!-- .container -->
			...
			<?php if ( get_field('warranty') || get_field('warranty_other') ) : ?>
				<h3 class="fancy mb-5">Buyer's Guide</h3>
						...
						<div class="col-sm-12">
							<div class="content-wrapper p-5">
								<ul class = "list-info list-inline">
									...
									<li>
										<h4 class = "mr-3 gold">Warranty</h4>
										<h4 class = "white"><?php the_field('warranty'); ?></h4>
									</li>
									<?php endif; ?>
									
									<?php if (get_field('warranty_other')) : ?>
									<li>
										<h4 class = "mr-3 gold">Details</h4>
										<h4 class = "white"><?php the_field('warranty_other'); ?></h4>
									</li>
								<?php endif; ?>
								</ul>
							</div><!-- .content-wrapper -->
			...
			<?php endif; ?>
				...
				<h3 class="fancy mb-5">Specifications</h3>
					...
					<div class="col-sm-12">
						...
						<div class="tab-pane fade show active" id="pills-options" role="tabpanel" aria-labelledby="pills-options-tab">
							<ul class = "list-unstyled">
							  <?php
							    ...
							    echo '<li><h5 class = "white">' . $item . '</h5></li>';
							  } ?>
							</ul>
						</div>
						...
						<div class="tab-pane fade" id="pills-mechanical" role="tabpanel" aria-labelledby="pills-mechanical-tab">
							<ul class = "list-info list-inline">
								...
								<li><h4 class = "mr-3 gold">Drivetrain</h4>
									<h4 class = "white"><?php the_field('drivetrain'); ?></h4>
								</li>
								<?php endif; ?>
								<?php if ( get_field('transmission') ) : ?>
								<li><h4 class = "mr-3 gold">Transmision</h4>
									<h4 class = "white"><?php the_field('transmission'); ?></h4>
								</li>
								<?php endif; ?>
								<?php if ( get_field('engine') ) : ?>
								<li><h4 class = "mr-3 gold">Engine</h4>
									<h4 class = "white"><?php the_field('engine'); ?></h4>
								</li>
								<?php endif; ?>
								</ul>
						</div>
						...
						<div class="tab-pane fade" id="pills-colors" role="tabpanel" aria-labelledby="pills-colors-tab">
							...
							<?php if ( get_field('exterior_color') ) : ?>
								...
								<h4 class = "white"><?php the_field('exterior_color'); ?></h4>
								</li>
							<?php endif; ?>
							<?php if ( get_field('interior_color') ) : ?>
								<li>
								<h4 class = "mr-3 gold">Interior Color</h4>
								<h4 class = "white"><?php the_field('interior_color'); ?></h4>
								</li>
							<?php endif; ?>
							<?php if ( get_field('top_color') ) : ?>
								<li>
								<h4 class = "mr-3 gold">Top Color</h4>
								<h4 class = "white"><?php the_field('top_color'); ?></h4>
								</li>
							<?php endif; ?>
							</ul>
						</div>
...
$secondaryPosts = new WP_Query( $args );
		...
		if ( $relatedPosts->have_posts() || $secondaryPosts->have_posts()  ) { ?>
			<div id="relatedCars" class = "py-5">
				<h3 class="fancy mb-5">Related Cars</h3>
				<?php  ?>
